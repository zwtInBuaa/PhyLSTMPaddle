...
def train(cfg: DictConfig):
    ...
    print(mat.keys())
    # 将 mat 中的内容输出到 res.txt 文
    # t = mat["time"]
    dt = 0.02
    n1 = int(dt / 0.005)
    # t = t[::n1]

    ag_data = mat["input_tf"][:, ::n1].astype(np.float32)  # ag, ad, av
    ...
    ag_pred = mat["input_pred_tf"][:, ::n1].astype(np.float32)  # ag, ad, av
